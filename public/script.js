const questions = {
    mujer: [
        ...
        { text: "¿Cómo te describes mejor?", options: [
            "Romántica y cálida",
            "Apasionada y elegante",
            "Tranquila y sensible",
            "Fresca y auténtica"
        ]},
        ...
        { text: "¿Cuál es tu estilo de vida principal?", options: [
            "Deporte / voy al gimnasio",
            "Trabajo en oficina / negocio",
            "Estudio / universidad",
            "Un poco de todo"
        ]},
        { text: "¿Para qué ocasión principal usarás el perfume?", options: ["Día a día / diario","Ocasiones especiales / noche"]}
    ],
    hombre: [
        ...
        { text: "¿Cómo te describes mejor?", options: ["Seguro y con presencia","Intenso y con carácter","Libre y auténtico","Sofisticado y con estilo"]},
        ...
        { text: "¿Para qué ocasión principal usarás el perfume?", options: [
            "Día a día / diario",
            "Ocasiones especiales / noche"
        ]}
    ]
};
